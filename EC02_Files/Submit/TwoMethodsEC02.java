 ...
 */
public class TwoMethodsEC02 {


    public static void charCount(String input, String fileName) throws IOException
    {
        
    }  
    
    public static String sentenceEditor(String text)
    {
    ...
    public static void main(String[] args) {
       ...
       testSentenceEditor(out);
       testCharCount(out);
       
    }
    public static void testSentenceEditor(PrintStream outputStream)
    {
 ...
 // Test #1
        ...
        if(sentenceEditor(test1).equals(match1)) 
        {
...
// Test #2
        if(sentenceEditor(test2).equals(match2)) 
        {
    ...
    */
   public static void testCharCount(PrintStream outputStream)
   {
    ...
    //--- Test 4 ---//
      try
      {
    	  charCount(test01, "noSuchDirectory/a.txt");
